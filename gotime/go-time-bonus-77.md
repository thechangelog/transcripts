**Adam Stacoviak:** How closely did we touch [WASM](http://webassembly.org/) on the show? The only reason I ask is we just talked to Lin Clark about WASM and Go isn't lately mentioned.
