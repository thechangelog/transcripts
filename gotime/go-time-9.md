...
**Carlisia Campos:** Glad to be here, hello.
...
**Carlisia Campos:** Is your metrics library also in Go?

**Scott Mansfield:** Yeah, the whole thing... It's all in the same repository.

**Carlisia Campos:** Because I was thinking to ask you as well, I'm not sure if it applies what I wanna ask anyway... If you're using a Prometheus to collect metrics and log information.
...
**Carlisia Campos:** And one FYI, Peter was on the Changelog podcast, and in that episode he goes over the components of the package, and he talks about stability and moving towards a stable release. It's a very good show.
...
**Carlisia Campos:** Of course she knows.

**Erik St. Martin:** She's like, "I wanna be on the mic, too." \[laughter\]

**Brian Ketelsen:** She likes attention.

**Carlisia Campos:** She's a future podcaster.

**Erik St. Martin:** I'll get her on the show when she can talk.

**Carlisia Campos:** I have a project I wanted to mention. Yet Another Web Framework (YAWF).

**Erik St. Martin:** So is that actually the name of the project, or is that what you've labeled it?

**Carlisia Campos:** No, that's an acronym I just came up with. But the name of the project is Iris.
...
**Carlisia Campos:** I heard the episode and I saw that, and I had to mention it.

**Brian Ketelsen:** You're just trolling me, Carlisia. That's not nice. \[laughter\]

**Carlisia Campos:** I have to try to get my way, somehow. \[laughter\]
...
**Carlisia Campos:** \[\\00:43:50.01\\\] And something about channels on Gopher Slack for people who are listening... Hop onto the GoTime FM channel, because we can all multitask here, we are very good at that and you wouldn't believe this. We have Adam tweeting for us, and we are all on the channel also typing, our guests are typing, and we're talking and doing all the things at the same time. So join us...
...
**Carlisia Campos:** It's concurrency, for sure.

**Brian Ketelsen:** Okay.

**Carlisia Campos:** Yeah. \[laughs\] Good question.
...
**Carlisia Campos:** This was fun, thanks Scott.
