...
**Erik St. Martin:** The beatings will commence until morale improves. But I think also -- like, we talked about how we got here, and it's interesting... When this conference was started, we always believed that people who knew how to run tech events would come build the big Go conference. But I think that whole caring about people and the community-first is the huge thing that probably made GopherCon what it is... Because from conference one, there were many of us, from organizing crew, to other speakers and stuff like that, that were in one of the hotel suites until all hours of the night, while some of the speakers did dry runs of their talks, and things like that. And over the years, it's become a much more formal thing, but that's always been prevalent.
