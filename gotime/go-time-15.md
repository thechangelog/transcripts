...
**Carlisia Campos:** And this is so timeless. It's going to be useful for probably forever. We just need to do a good job resurfacing these posts once in a while.
...
**Carlisia Campos:** That's exactly the name of the conference talk that I think should be derived from the Standard Package Layout blog post. Packages as a Service \[laughter\].
...
**Carlisia Campos:** Going back to something that Ben said… Ben, what do you think or tell people when they say, "Well, Go is not really for web apps; I don't know if it's even for API." Do you hear people say that?
...
**Carlisia Campos:** That's a call-to-action for you too, Brian \[laughter\].
...
**Carlisia Campos:** I know what you're talking about, it was at Gopher Gala. I did it once... Rails Rumble.
...
**Carlisia Campos:** I want to make sure we get Ben to answer the question that Erik asked.

**Erik St. Martin:** Answer the question, Ben! \[laughter\]

**Carlisia Campos:** Now that you've written a couple of really thorough blog posts on doing the walkthrough with Go Standard libraries, are you up to doing more of it?
...
**Carlisia Campos:** I'm easy like that. So this is not an ORM, this is a productive data access layer for Go. I'm finding this so funny because I think in every other language, a package like this will say, "We are an ORM. We are the best ORM", no matter how full-featured it was. But with Go, it was like, "No, no, no. We're not an ORM! We're not an ORM. \[laughs\]

**Brian Ketelsen:** It's a dirty word in Go.

**Carlisia Campos:** It's a totally dirty word, right? So much. I chuckle every time.
...
**Carlisia Campos:** With this, you can totally just send SQL. So I like that because I anticipated that I would need to do that. If it didn't have that feature, I wouldn't use it. But I think all of these libraries will have that, I would imagine. So you get something... You get both things.
...
**Carlisia Campos:** Yeah. There is the performance issue that if you're not aware what's going behind scenes, you can get into trouble. That might also be the issue where you want to do something a little bit different, and now what? But you can always fall back to SQL, I guess.
...
**Carlisia Campos:** I can go next. First, let me mention that library I was talking about, it's upper.io/database.

**Brian Ketelsen:** Oh, the database library earlier?

**Carlisia Campos:** Yeah. The not-ORM library. Before I forget too, I want to mention that Ben did a remote meetup event and he showed how to use BoltDB. That was pretty awesome.

**Erik St. Martin:** Oh, cool, was that recorded?

**Carlisia Campos:** It is, yes. So if you go to remotemeetup.golangbridge.org, you will have the past events, and you'll find his event there. It was very good, I saw that one.

**Erik St. Martin:** Oh, awesome.

**Carlisia Campos:** The free software I want to mention today is called Stow, it's part of the… I don't know how to pronounce this…

**Erik St. Martin:** GNU.

**Carlisia Campos:** GNU, yes. I found this out through looking through Brian's and Erik's Doc files. I don't understand how I've been a programmer this long and I didn't know about this.

**Erik St. Martin:** It's actually used under the covers for a lot of stuff to manage new versions of libraries.

**Carlisia Campos:** I thought it only did symlinks?
...
**Carlisia Campos:** Interesting.

**Brian Ketelsen:** But it's very useful for DOT files.

**Erik St. Martin:** Yeah. I cheated for DOT files \[laugh\].

**Carlisia Campos:** I see, I see. That's why the description here was a bit off from what I was expecting. But yeah, to manage DOT files… Wow, it's so easy. It's so easy to use! Can't believe I didn't know about it. Not I use it to manage my symlinks.
...
**Carlisia Campos:** My biggest problem with symlinking manually was to remember how to un-symlink things. With Stow there's a delete command, and it's so easy.

**Erik St. Martin:** Yeah. To un-Stow it?

**Carlisia Campos:** Yes, or un-Stow; I don't know, I don't know remember. I only did it once. I set it up super quickly and it worked, and I never had to look at it again. That's why I thought it was so great.
...
**Carlisia Campos:** Yes, thank you. You did a great job explaining how it works, Erik. Thank you.
...
**Carlisia Campos:** And none of them are in the Slack right now. I'm sorry \[laughter\].
...
**Carlisia Campos:** Wow, her talk was awesome, I thought.
