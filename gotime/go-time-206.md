...
So you kind of need to factor in the fact that in a distributed system, especially when messages are involved, which is a common thing for evented systems using queues and event bridge for example is a common one with AWS or what not, so with these kinds of systems, you kind of have to factor in the fact that you may get a message multiple times, and it's up to you as a developer -- then I have to solve it at a systems level, at this point. It's up to you as a developer to engineer your software for that eventuality
...
**Mat Ryer:** \[27:56\] So is this the case where every service, every microservice needs to know how to kind of undo itself? Or maybe not, depending on your case.
...
**Mat Ryer:** We won't be able to put Tiago's talk in the show notes, because I don't think it's going to be published by the time this episode goes out, but... keep on gotimefm on twitter we'll tweet it there or eventually you'll find it.
...
**Mat Ryer:** Coming up next on Insurance Time, we're gonna be talking about premiums. \[laughter\] Of course, Tiago and I live in a country that has centralized health care.
...
**Mat Ryer:** Well, definitely in Facebook's case... And those things - it's fine if those things are just like servers or bits of UI, but when they're democracies... Then yeah, I would like to go a bit slower, thank you...
...
**Mat Ryer:** No, I just asked jeeves still. We only have that in the U.K.
...
**Mat Ryer:** Oh yeah it's not gonna be is it, Jerod.
...
**Tiago Mendes:** I don't know if they've solved it yet. I remember that a few years ago it was still very -- you had to use Tokio for the HTTP library to do things, I think... So it felt a lot more lower-level than Go.
