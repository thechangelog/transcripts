...
\[10:02\] I think one of the things that we're definitely gonna be talking about, also part of the standard library, is the slog, the s log, however you want to pronounce it, sort of expansion of the log package. Personally, I'm happy that it's in there, but my immediate reaction was like "I have to give up logrus? \[laughs\] What am I going to miss?" I had this sort of immediate reaction, because I've been using logrus for quite a while, and other people have their own sort of favorite packages, too... There's zap, there's a few out there that people have gotten used to... But now it has this one in the standard library proper.
...
**Johnny Boursiquot:** \[52:09\] You just have to quote properly. Quote properly. Quote everything, make sure you have the right number of tabs, and the right number of spaces, indentations... If you've ever done Python, you know the life of having the appropriate spacing, and things. So yeah...
