...
**Jaana Dogan:** Yeah. There's actually something from Robert Griesemer that he used to say... He's the person who's maintaining go fmt, and all the tools and so on. He says that he doesn't agree with all the styling; he doesn't necessarily agree with go fmt, but some tool is enforcing it, so there's no question.
