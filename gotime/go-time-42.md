...
**Kavya Joshi:** Yeah, so for our secrets, in ECS... Well, you basically run a Docker container. So you can pass in environment variables to your Docker container; other than that, I think you can manage access control on your other resources using Amazon \[unintelligible 00:26:44.18\] I don't think they have anything specifically for secrets, but you can make existing systems work.
