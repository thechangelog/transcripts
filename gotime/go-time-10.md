...
**Carlisia Campos:** Glad to be here.
...
**Carlisia Campos:** 2,401, I took it today. \[laughter\]
...
**Carlisia Campos:** \[\\00:03:57.03\\\] So what are the dependency packages that you support at Heroku?
...
**Carlisia Campos:** Do you have stats that you can share for how many projects use one or the other?
...
**Carlisia Campos:** Does anybody have any insights as to the states of resolution on this issue? Is vendoring something that's going to be solved soon, or it's not on the plate? I haven't been following, but it's important enough...
...
**Carlisia Campos:** Is anybody from the Go Language Team in there?
...
**Carlisia Campos:** I was thinking the same thing, along those lines. The Go Language Team is part of the community, and it's sort of odd that there's a group of people working on a solution without any input or feedback from the Language Team. Are they aware that this is happening, or...?
...
**Carlisia Campos:** Ed, I don't remember if you said the name of the channel where this conversation is happening...
...
**Carlisia Campos:** \[\\00:19:53.17\\\] But let me see if I understand. Right now is there anything that we can do with those versionings? Because if it's no, I see the point of people not using it, and I think that more people would do it if there was a function for it.
...
**Carlisia Campos:** Do you have more...? Continue please, I don't wanna interrupt.
...
**Carlisia Campos:** What I wanted to ask is are these rewrites, or majority rewrites, or majority new things...?
...
**Carlisia Campos:** \[\\00:32:15.05\\\] I have a sense that the whole internet is being rewritten in Go.
...
**Carlisia Campos:** What are you talking about?
...
**Carlisia Campos:** I wanna say we're gonna have Beyang on the show in three weeks from now.
...
**Carlisia Campos:** And they host a meetup in San Francisco. I don't know how often it is, but I went to one, it was pretty great. There were people from LinkedIn there speaking, and other people on the panel. It was pretty awesome.

**Erik St. Martin:** I'm seeing the trail in GoTime FM. \[laughter\] You guys are distracting me.

**Carlisia Campos:** No, that was pretty amazing. I said his name and he popped into the channel.
...
**Carlisia Campos:** Yeah, and Git service - GitHub or GitLab - is something that we use every day, so it will be interesting to look at how that can be implemented in Go. I found it interesting to dig around.
...
**Carlisia Campos:** And talking about involvement from Heroku, I wanted to also mention that Heroku is a big supporter of GoBridge, financially and otherwise, and Ed is as well. You have taught a GoBridge workshop in San Francisco, we're very grateful for that, so thank you.
...
**Carlisia Campos:** And there's that Go Doc Tool that I talked about I think in the second episode, or I forgot which episode. That does the same thing. It will jump to the code source...

**Ed Muller:** Are you talking Pythia?

**Carlisia Campos:** No, it's called Go Doc.
...
**Carlisia Campos:** This was fun. Bye, everybody.
