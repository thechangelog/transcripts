...
**Adam Argyle:** Yeah, cool. I've just been building apps in this industry for a long time. I was hacking on websites before Flash and Flex came around, and I jumped on that bandwagon. I was building all these big, robust Swifts with \[unintelligible 00:03:37.16\] and MVC patterns back in the day, and I got pumped on Swift's native platform, so I was pushing Flash apps onto your iPhone... They were not very good, but I was doing it anyway. \[laughter\] And I'm just a web fanatic, so I happily pivoted into the web, and I've been kind of going along with everybody else. I wrote a bunch of jQuery stuff; I still love jQuery. I wrote a bunch of Backbone; I'll write Angular 1, I'll write Angular Infinity, I'll write React - I don't care. And that's why the tool \[unintelligible 00:04:07.23\] If you ask me what I wanna use, I wanna use the least amount possible.
...
**Kevin Ball:** Yeah. Well, your HTML may be \[unintelligible 00:18:26.29\]
...
**Adam Argyle:** Oh, that's probably because you've got \[unintelligible 00:25:58.01\] and I'm using getComputedStyle(), and it's just turning it into a pixel. I'd like to actually \[unintelligible 00:26:03.22\] I want designers to use those units. I want designers to use those web units; it's a goal of VisBug eventually.
...
**Adam Argyle:** Yeah, give me a quick little breakdown; unpack that for me. Or we could do it on the side, I don't know; we could \[unintelligible 00:33:54.06\]
...
**Jerod Santo:** \[unintelligible 00:47:17.06\]
