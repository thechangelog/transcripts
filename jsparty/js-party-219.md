...
**Bret Comnes:** \[04:04\] Good! Great to be here.
...
**Feross Aboukhadijeh:** \[12:13\] Yeah, so I think it's worth maybe just spending a second distinguishing between vulnerabilities and malware.
...
**Bret Comnes:** \[20:08\] Yeah. So ultimately, if you're deploying a project to some sort of production environment, that line will -- if they have Socket installed, they'll get the analysis at that level for the entire tree as well. So that's kind of the idea at the moment.
