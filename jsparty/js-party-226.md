...
**Jerod Santo:** Yeah, what a fascinating turn of events that would be, if all of a sudden WebAssembly became the new Docker of our server-side things... Just - didn't see that one coming, you know? It turns out maybe that's the case. That's cool.
