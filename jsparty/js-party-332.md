...
**Christopher Hiller:** \[39:47\] You can't make things typesafe, but you can use with in a way that will sandbox the code that's running in it... Which makes it useful for certain things. But it's also deprecated, and everybody hates it and doesn't want to add it to their new JavaScript runtime, or what have you. Anyway, with is like a big deal for me. It's part of my job, is the with statement.
...
**Christopher Hiller:** \[48:16\] Yeah... I will say that -- I haven't tried this new thing, but it can be difficult to get that working in like a monorepo. Like, what do I put in this project field? And you end up with files using the wrong tsconfig, essentially. So that is a welcome change, and I'm eager to check it out and see if that makes things as easy as you claim they are.
