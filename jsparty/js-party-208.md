...
**Ali Spittel:** Yeah. I did a Twitter Space with the developer advocate for serverless at AWS, and they were talking about this as well... Serverless is really difficult to define; people think it functions as a service, but then there's also other serverless services too, like DynamoDB, or serverless databases that have some traction right now, like FaunaDB... So it goes far beyond that. So I think this is a really interesting conversation, of defining what the real single is.
