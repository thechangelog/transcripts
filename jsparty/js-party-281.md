...
**Eric Clemmons:** Hey! Happy to be here. Ba ba ba ba bam
...
**Jerod Santo:** Right. Pry is a tool in Ruby...
...
\[38:14\] And so anytime I do something ephemeral, like putting into console.log, that ultimately gets deleted from that bug, that nagging voice is saying "Well, you could have been doing test-driven development for this, right? Couldn't this have been a test to make sure it doesn't happen again, instead of you just logging out, "Oh I wasn't doing a typecheck here,"nNow the undefined isn't happening, and I fixed it." So that's usually how the flow goes, is identification, reproduction, and then whether or not that fix is going to be resilient to more code changes in the future.
