...
**Jerod Santo:** That's exactly what was \[unintelligible 00:37:54.00\], so good job! \[laughs\]
...
**Dmitry Jemerov:** Yeah, well one thing I find very interesting about Kotlin and Swift is how close they are in terms of design, even though we did not talk to each other at all until very late. I once gave a presentation about Kotlin and Apple where Chris Lattner was present, but we didn't \[unintelligible 00:39:19.25\] as joint development, or anything like that... So when Swift was open-sourced, we saw that we started almost exactly at the same time; Swift was just \[unintelligible 00:39:36.22\] inside of Apple, and we opened up earlier and started telling about what we do. The design is very similar, and I think it's just more like convergent evolution than any kind of conscience \[unintelligible 00:39:47.27\] to another.
...
**Jerod Santo:** There was a day in the past where you used to have to convince people that it was worth a build step, it was worth a compilation step in their frontend development workflow, to use a different language. Nowadays, even people who are writing plain old Javascript, maybe they're writing ES6 or ES7 \[unintelligible 00:46:47.04\] for Javascript to Javascript, so that's probably not something that you necessarily are gonna have too much of a battle with people winning them over... "Hey, you've gotta compile your Kotlin to your Javascript", but perhaps you might be concerned about debugging, and performance, and the overall quality of the compiled Javascript. Is that something you guys are addressing as well?
...
**Adam Stacoviak:** Something about what's coming up here - you have Kotlin Conf coming up later this year. You mentioned -- I believe it's Andrey Breslav, he's the creator of this language... Is he one of or many of the creators of this? Was it his idea or not? \[unintelligible 00:49:23.14\]
