...
**Jerod Santo:** \[30:01\] What languages were you familiar with coming into it that that made you feel that way?
...
**Jerod Santo:** \[38:06\] Push notifications on?
...
**Philipp Heckel:** And so yeah, it rings continuously. So I did that after the fact...
...
**Jerod Santo:** True. I mean, I didn't even know I wanted the Android app at this point, so...
...
**Philipp Heckel:** \[53:04\] Yeah, that's a little odd. Ntfy was built by -- the same goes for the web app. It's a web app that only runs in the browser, and stores state in the browser. There's no account.
