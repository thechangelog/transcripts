...
**Jerod Santo:** \[24:15\] Yeah, grateful.
...
\[28:12\] So when Redis \[unintelligible 00:28:10.08\] performs for 10 years or even more a memory check of the system it is running on in order to report broken memory. And now it's of no use, because most memory is error protected. But back then, a lot of cheap memory created problems.
