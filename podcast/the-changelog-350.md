...
And then we, the core team, we're very committed to supporting out users... So I think for a long time, before the project really got big, if somebody sent an email out to the ODK mailing list, somebody (generally, often me) would get a response in under an hour. So being able to support people who are using this piece of software was a big growth driver.
