...
\[23:52\] Now, all that said, as of right now, right now we're only on Amazon, and we'll be adding \[unintelligible 00:23:56.15\] cloud. In which order, and what's going to come sooner, Fly or Google, for example, I can't really commit to, because we are continuously evaluating.
