...
I worked for Microsoft, as I've just said, for 23+ years. Now I work as a consultant and I wrote this book that came out last fall, "The Problem With Software: Why Smart Engineers Write Bad Code," which as you said, tries to answer that question.
...
I'm actually sympathetic to Academia in that situation. They really don't need to attempt to keep up with the absolute latest and greatest, because if you've had experience working on large pieces of code, then you can work on other large pieces of code. That knowledge transfers.
...
So I think students could study that, but they could also try to do a little bit themselves. They could actually try to do a little research project where "We write code in two different ways or two different languages or with two different constraints, and actually try to figure out something about which is better." Probably to learn about it, and probably just to get students to realize that there are different ways to write code, and the way they've learned or taught themselves may not be the only way.
...
Those are some very constricting rules, that she believes produces good code... Or I guess, her words are produces clean code. So that produces clean code. So definitely some work being done in this space, but no consensus, because a lot of people would disagree with those rules.
...
**Jerod Santo:** Here's a pro tip for people who are writing best practices or pattern style - if you aren't sure if it's a good idea or a bad idea, don't call it a law. The Law of Demeter - I think that's maybe the hubris there; even though they admit, like you said, in their paper that "This is a concept, we see some value to it." You call something a law, something like gravity, right? We're all pretty much stuck to that one. Ha! But with the Law of Demeter, as a young programmer, you hear law and you think "Alright, I can never call through to C. It's just a rule." That's problematic.
...
**Jerod Santo:** It turns out physical retail stores have value. 

**Adam Stacoviak:** They do.

**Jerod Santo:** Who would have thought...?

**Adam Stacoviak:** Who would have thought...? And they've got cool music in there, a decent environment... It depends on when you go too, of course, but I'm an advocate of it.
