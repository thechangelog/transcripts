...
**Jerod Santo:** Yeah, so it's kind of like -- I wouldn't call it hijacking that Red Hat log, but it's kind of like forcing it to be there long enough that it can piggyback the data over, and then it flushes.
