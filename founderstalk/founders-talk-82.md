...
I had a climbing buddy who had started a company in Seattle; probably people don't know that anymore, it's now part of the roleup it's called WRQ it's a super fast-growing company... And I got involved with them, and I joined them, and was around for the early days of TCP/IP...
...
**Evan Kaplan:** Yeah. I didn't see myself as a CEO for hire. I saw myself as a partner. So Paul and I struck up this agreement that I think has held us really well for a long time now, which is he's never treated me as anything but a founder, even though I'm not, technically... And I've never treated him as anything but a partner. I don't make any major decisions about the product, the company without he and I being in alignment about it... Which is wonderful, because we fight, we make fun of each other, we do a lot of stuff together, but we've maintained that relationship.
...
**Adam Stacoviak:** \[12:00\] Yeah, absolutely. You mentioned some convictions about open source... What were the positives, I suppose, and negatives to those convictions?

**Evan Kaplan:** You know, I think it became clear to me that, particularly as a data and the infrastructure framework, there was a huge displacement gonna happen from what was classic during most of my career; you could use Oracle, and you could do Db2, and if you were super-adventurous you'd use CybExer and Formex. And obviously, over the last 15 years, starting with MySQL and the other database platforms, you saw the fragmentation of most franchises, and you were seeing a slow and sure, steady replacement of those franchises, too... And they were all open source.
...
**Adam Stacoviak:** \[31:52\] I'm a "celebrate the wins" kind of person. That's why I frame that question like that, because I think you have to celebrate the wins, and I think it does take some effort to see the wins, because sometimes you're just so focused on the horizon that you kind of forget all the little narrow pathways and all the different things you've done to get there, as a team, as an individual. I'm personally a "celebrate the wins" kind of person; I feel like that really amps things up, and you can see that, and then also do it.
...
**Adam Stacoviak:** I like to pay attention to those people, because -- you know, I just borrow a lot of things from a lot of people. Simon Sinek, Nir Eyal, a lot of different folks.
...
\[52:11\] So we show up -- and that's a part of relationship, you can't just transaction your way to success. Just so often, especially as a CEO, you have to do a lot of selling, which means you tend to be transactional often. But I think if we can sort of like take a couple clicks back and be relational AND think about the transaction, but more about the relationship involved - that's the win.
...
**Evan Kaplan:** Right, because it's sensors, and InfluxData... So I measure it, and I track it, and I try to get a good night's sleep and whenever I'm not, I work out about an hour and a half every morning...
...
**Evan Kaplan:** Yeah, I didn't expect you to ask me about those. But I've noticed you talking about James Clear, and some of the micro-habits, and that sort of stuff. I'm kind of a systems guy; I like having -- you know that was true of climing a few years ago, and I like having my systems down. I know it gives me a lot of freedom if I have my systems down. So I like having a system, I like organizing around a model... So it helps.
