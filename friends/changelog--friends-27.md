...
**Adam Stacoviak:** \[42:07\] I used to have a CloudKey. I used to have the one that dongled in. It was PoE-d in, that thing that hung out of it, from back in the day. Yeah, that's how I had to do it. It was a CloudKey. And I guess they now have a true CloudKey, which is actually in the UniFi cloud.
...
**Techno Tim:** \[57:57\] And that's why they sometimes say -- you'll get a free defrag when you do that; maybe not, but people like to every now and then take all their data off those drives and put it right back on. \[laughs\] Because then it distributes it evenly.
